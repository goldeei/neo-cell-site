...
const About = () => {
	return (
		<Section id="about" className="page-gradient">
			<div className="h-full flex flex-col justify-between items-around lg:grid gap-auto lg:grid-cols-6 lg:grid-rows-1">
				<div className="flex-1 gap-6 lg:col-span-4 flex flex-col justify-center lg:gap-12">
					<div className="text-header-blue-500 text-3xl md:text-4xl xl:text-6xl leading-tight font-medium tracking-tight">
						Revolutionizing Cell Therapy Monitoring & Analysis
					</div>
					<div className="text-lg sm:text-xl xl:text-2xl 2xl:text-3xl flex flex-col gap-6 font-light leading-snug">
						<div>
				...
				<div className="col-span-2 flex items-center justify-end">
					<div className="w-1/2 items-center grid gap-4 grid-cols-3 lg:grid-cols-1 lg:grid-rows-3 lg:col-start-6">
